...
<?php foreach ($comments as $comment) : ?>
	...
	<div class="paginated-comments-number" style="float: left; color: #666; width: 30px;"><?php Paginated_Comments_numeration(); ?>.</div>
	<?php
...
<p><?php printf(__('Logged in as %s.'), '<a href="'.get_option('siteurl').'/wp-admin/profile.php">'.$user_identity.'</a>'); ?> <a href="<?php echo function_exists('wp_logout_url') ? wp_logout_url(get_permalink()) : get_option('siteurl') . '/wp-login.php?action=logout'; ?>" title="<?php _e('Log out of this account') ?>"><?php _e('Log out &raquo;'); ?></a></p>
