...
<?php if ( $comments ) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="paginated-comments-number" style="float: left; color: #999; width: 30px; text-align: left;"><?php Paginated_Comments_numeration(); ?></div>
			<?php
...
<p>Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo function_exists('wp_logout_url') ? wp_logout_url(get_permalink()) : get_option('siteurl') . '/wp-login.php?action=logout'; ?>" title="Log out of this account">Logout &raquo;</a></p>
